...
<div class="row">
  ...
  <div class="small-12 large-9 columns {{ ($errors->first('company_name')) ? 'error' : '' }}">
    {{ Form::text('company_name', Input::old('company_name') ?: (!empty($client) ? $client->company_name : ''), [ 'placeholder' => 'Acme, Inc' ]) }}
...
<div class="row">
  ...
  <div class="small-12 large-4 columns {{ ($errors->first('first_name')) ? 'error' : '' }}">
    {{ Form::text('first_name', Input::old('first_name') ?: (!empty($client) ? $client->first_name : ''), [ 'placeholder' => 'Joe' ]) }}
  ...
  <div class="small-12 large-5 columns {{ ($errors->first('last_name')) ? 'error' : '' }}">
    {{ Form::text('last_name', Input::old('last_name') ?: (!empty($client) ? $client->last_name : ''), [ 'placeholder' => 'Smith' ]) }}
...
<div class="row">
  ...
  <div class="small-12 large-9 columns {{ ($errors->first('address')) ? 'error' : '' }}">
    {{ Form::text('address', Input::old('address') ?: (!empty($client) ? $client->address : ''), [ 'placeholder' => '123 Main St' ]) }}
...
<div class="row">
  <div class="small-12 large-offset-3 large-4 columns {{ ($errors->first('city')) ? 'error' : '' }}">
    {{ Form::text('city', Input::old('city') ?: (!empty($client) ? $client->city : ''), [ 'placeholder' => 'City' ]) }}
  ...
  <div class="small-12 large-2 columns {{ ($errors->first('state')) ? 'error' : '' }}">
    {{ Form::text('state', Input::old('state') ?: (!empty($client) ? $client->state : ''), [ 'placeholder' => 'State' ]) }}
  ...
  <div class="small-12 large-3 columns {{ ($errors->first('zip')) ? 'error' : '' }}">
    {{ Form::text('zip', Input::old('zip') ?: (!empty($client) ? $client->zip : ''), [ 'placeholder' => 'Zip' ]) }}
...
<div class="row">
  ...
  <div class="small-12 large-9 columns {{ ($errors->first('email')) ? 'error' : '' }}">
    {{ Form::email('email', Input::old('email') ?: (!empty($client) ? $client->email : ''), [ 'placeholder' => 'joe@example.com' ]) }}
...
<div class="row">
  ...
  <div class="small-12 large-9 columns {{ ($errors->first('phone')) ? 'error' : '' }}">
    {{ Form::phone('phone', Input::old('phone') ?: (!empty($client) ? $client->phone : ''), [ 'placeholder' => '602 555-1212', 'type' => 'tel', 'pattern' => '\d{3}\s?\d{3}[\-]?\d{4}' ]) }}
